...
use App\Http\Controllers\TopicController; // Your clean Web Topic Controller
...
Route::middleware(['auth'])->group(function () {
    ...
    // ---------- Logout ----------
    // For safety, let's keep both GET and POST definitions for a seamless UI experience
    ...
    // Unifies team route with your dedicated TopicController view handler!
    Route::get('/groups/{group}/topics/{topic}', [TopicController::class, 'show'])->name('topics.show');
