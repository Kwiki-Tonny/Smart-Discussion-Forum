...
{{-- Override the workspace layout's container to allow full page scroll --}}
@section('container_class', 'min-h-screen flex flex-col')

@section('context_panel')
    {{-- Sidebar content – no overflow constraints, scrolls with page --}}
    <div class="p-4 border-b border-[#E5E5E5] flex items-center bg-white">
...
@section('content')
    <div class="bg-[#F9F9F9]">
        ...
        {{-- STICKY HEADER --}}
        <div class="sticky top-0 z-10 bg-white border-b border-[#E5E5E5] px-8 py-6 shadow-sm">
                ...
                <div class="bg-white rounded-lg border border-[#E5E5E5] shadow-sm p-5">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="text-xs font-bold uppercase tracking-wider text-[#000000]">Top Active Students</h3>
                        </div>
