...
public class MainApp extends Application {
    ...
    public static void switchToMain() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("/com/demo/Main.fxml"));
            ...
            scene.getStylesheets().add(MainApp.class.getResource("/com/demo/style.css").toExternalForm());
